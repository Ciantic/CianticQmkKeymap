...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox(KC_ESCAPE, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, LGUI(KC_R), MO(1), KC_A, KC_S, KC_D, KC_F, KC_G, KC_LSHIFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_LGUI, KC_LCTRL, KC_NONUS_BSLASH, KC_LGUI, KC_LALT, MO(3), KC_MEDIA_PLAY_PAUSE, KC_AUDIO_MUTE, KC_TRNS, KC_SPACE, OSL(4), MO(2), KC_6, KC_7, KC_8, KC_9, KC_0, KC_LBRACKET, KC_BSPACE, KC_TRNS, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_NONUS_HASH, KC_H, KC_J, KC_K, KC_L, KC_SCOLON, KC_QUOTE, KC_ENTER, KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLASH, KC_RSHIFT, MO(3), KC_RALT, KC_APPLICATION, KC_LALT, KC_RCTRL, KC_MEDIA_PREV_TRACK, KC_MEDIA_NEXT_TRACK, KC_TRNS, MO(2), OSL(4), KC_SPACE),
  [1] = LAYOUT_ergodox(KC_TRNS, MOD_F13(KC_1), MOD_F13(KC_2), MOD_F13(KC_3), MOD_F13(KC_4), MOD_F13(KC_5), KC_TRNS, KC_TRANSPARENT, MOD_F13(KC_Q), MOD_F13(KC_W), MOD_F13(KC_E), MOD_F13(KC_R), MOD_F13(KC_T), KC_TRNS, KC_TRNS, KC_TRNS, LALT(LCTL(LSFT(KC_S))), KC_LALT, KC_LSHIFT, KC_SPACE, KC_TRNS, KC_TRNS, MOD_F13(KC_X), MOD_F13(KC_C), MOD_F13(KC_V), MOD_F13(KC_B), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RGB_MOD, RGB_SLD, RGB_VAI, KC_LCTL, RGB_TOG, RGB_VAD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DELETE, KC_HOME, KC_UP, KC_END, KC_PGUP, KC_TRNS, KC_ENTER, KC_LEFT, KC_DOWN, KC_RIGHT, KC_PGDOWN, KC_TRNS, KC_TRNS, KC_BSPACE, KC_TRNS, KC_TRNS, RGB_MODE_GRADIENT, RGB_MODE_XMAS, RGB_MODE_KNIGHT, RGB_MODE_SNAKE, RGB_MODE_SWIRL, RGB_MODE_RAINBOW, RGB_MODE_BREATHE, RGB_MODE_PLAIN, KC_TRNS, KC_SYSTEM_SLEEP, RGB_MODE_RAINBOW, RGB_HUI, KC_TRNS, KC_TRNS),
  [2] = LAYOUT_ergodox(KC_TRNS, KC_NUMLOCK, KC_KP_7, KC_KP_8, KC_KP_9, KC_KP_SLASH, KC_TRNS, KC_TRNS, KC_TRNS, KC_KP_4, KC_KP_5, KC_KP_6, KC_KP_ASTERISK, KC_TRNS, KC_TRNS, KC_TRNS, KC_KP_1, KC_KP_2, KC_KP_3, KC_KP_MINUS, KC_TRNS, KC_TRNS, KC_TRNS, KC_KP_0, KC_KP_DOT, KC_KP_PLUS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, EEPROM_RESET, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
  [3] = LAYOUT_ergodox(KC_GRAVE, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, LALT(KC_TAB), KC_TRNS, KC_NONUS_HASH, LSFT(KC_3), LSFT(KC_6), KC_TRNS, KC_TRNS, KC_TRNS, LSFT(KC_1), LSFT(KC_2), RALT(KC_2), RALT(KC_4), LSFT(KC_5), MO(5), KC_NONUS_BSLASH, LSFT(KC_NONUS_BSLASH), RALT(KC_NONUS_BSLASH), KC_NONUS_BSLASH, LSFT(KC_NONUS_BSLASH), LSFT(KC_NONUS_BSLASH), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_SPACE, KC_TRNS, KC_TRNS, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, LSFT(KC_RBRACKET), KC_TRNS, BACKTICK, LSFT(KC_7), RALT(KC_8), RALT(KC_9), KC_RBRACKET, RALT(KC_RBRACKET), LSFT(KC_0), RALT(KC_7), LSFT(KC_8), LSFT(KC_9), RALT(KC_0), KC_NONUS_HASH, KC_ENTER, KC_TRNS, RALT(KC_MINUS), LSFT(KC_MINUS), KC_MINUS, LSFT(KC_NONUS_HASH), MO(5), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_SPACE),
